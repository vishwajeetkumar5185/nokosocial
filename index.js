...
const searchMessage=()=> {
    ...
    message.forEach(chat => {
        ...
        if(name.indexOf(val) != -1){
            chat.style.dispaly='flex';
        }else{
         chat.style.dispaly='none';
        }
...
messagesNotification.addEventListener('click', () => {
    ...
    messagesNotification.querySelector('.notification-count').style.dispaly = 'none';
...
fontSizes.forEach(size => {
   ...
   } else if(size.classList.coptains('font-size-4')){
